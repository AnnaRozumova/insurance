...
from pojisteni.models import Pojistence, TypyPojisteni, Pojisteni, Uzivatel, UzivatelManager
...
admin.site.register(Pojistence)
admin.site.register(TypyPojisteni)
